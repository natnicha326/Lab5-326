  ...
  <div>
    <div class="player-container">
      <div>
        ...
        <div>
          <img v-if="player1Choice === 'ค้อน'" src="./img/rock.png" alt="ค้อน" />
          <img v-if="player1Choice === 'กระดาษ'" src="./img/paper.png" alt="กระดาษ" />
          <img v-if="player1Choice === 'กรรไกร'" src="./img/scissors.png" alt="กรรไกร" />
        </div>
        <div>
           <h3>ออก:</h3> {{ player1Choice }}
        </div>
        <div>
          <h3>ผลการเป่ายิ้งฉุบ:</h3> {{ gameResult1 }}
        </div>
      </div>
      ...
      <div>
        ...
        <div>
          <img v-if="player2Choice === 'ค้อน'" src="./img/rock(1).png" alt="ค้อน" />
          <img v-if="player2Choice === 'กระดาษ'" src="./img/paper(1).png" alt="กระดาษ" />
          <img v-if="player2Choice === 'กรรไกร'" src="./img/scissors(1).png" alt="กรรไกร" />
        </div>
        <div>
          <h3>ออก:</h3> {{ player2Choice }}
        </div>
        <div>
          <h3>ผลการเป่ายิ้งฉุบ:</h3> {{ gameResult2 }}
        </div>
      </div>
    ...
    <div>
      <button @click="playRound" class="round-button">เป่ายิ้งงงงงงงงงฉุบ</button>
      <button @click="resetGame" class="reset-button">เริ่มใหม่</button>
    </div>

    <div class="score-container"> 
    <h2 class="score-text">ผลคะแนน {{ player1Score }} : {{ player2Score }}</h2> </div>
  </div>
</template>
